...
public class Feeder extends SubsystemBase {
  ...
  public void stopLRFeeder() {
    feederLeft.stopMotor();
    feederRight.stopMotor();
  }

  public void FeederRev(double feederSpeed, double rightFeederSpeed){
    feederLeft.set(-feederSpeed);
    feederRight.set(rightFeederSpeed);
  }
  public void stopMFeeder(){
    feederMid.stopMotor();
  }


  public void startLRFeeder(double feederSpeed, double rightFeederSpeed) {
    feederLeft.set(feederSpeed);
    feederRight.set(-rightFeederSpeed);
  }
  
  public void startMidFeeder(double feederSpeed){
